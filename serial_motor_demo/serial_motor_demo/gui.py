...
class MotorGui(Node):
    ...
    def __init__(self):
        ...
        self.mode_btn = Button(mode_frame, text="ZZZZ",
        ...
        self.max_val_update_btn = Button(
            slider_max_frame, text='Update', command=self.update_scale_limits, state="disabled")
        ...
        self.m2 = Scale(m2_frame, from_=-255, to=255,
        ...
        self.mot_2_spd_lbl = Label(speed_frame, text="XXX")
